...
This README document consists of whatever steps are necessary to get the application up and running.
...
* Open the notebooks using the launcher of choice, ie Jupyter lab or Jupyter Notebook to view the code and run all cells in the order in which they appear. 
* Create a virtual environment of choice and run the commands in the anaconda terminal to launch the environment. 
* Open and select the notebooks from this repository.
* These are the necessary dependencies that are required and must be satisfied. 

The following are the requirements needed to run and possible deploy the model. 
...
### How to run the App ###
* To run the app use the anaconda terminal and begin to navigate into the deployment directory.
* Run the app by using the python app.py command and press ctrl and click on the link to be directed to the index page. 
